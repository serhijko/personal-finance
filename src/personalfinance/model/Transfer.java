...
public class Transfer extends Common {
    ...
    public Transfer(Account fromAccount, Account toAccount, double fromAmount, double toAmount,
                    String notice, Date date) throws ModelException {
    ...
    public Transfer(Account fromAccount, Account toAccount, double fromAmount, double toAmount,
                    String notice) throws ModelException {
        this(fromAccount, toAccount, fromAmount, toAmount, notice, new Date());
    }

    public Transfer(Account fromAccount, Account toAccount, double fromAmount, double toAmount,
                    Date date) throws ModelException {
    ...
    private void setAmounts(SaveData saveData) {
        for (Account account : saveData.getAccounts()) {
            account.setAmountFromTransactionsAndTransfers(saveData.getTransactions(), saveData.getTransfers());
        }
    }
}
